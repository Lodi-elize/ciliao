...
const styles = StyleSheet.create({
  ...
  actionIcon: { flexShrink: 0, width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.lemon },
  actionIconText: { color: colors.ink, fontSize: 18, fontWeight: '900', includeFontPadding: false },
